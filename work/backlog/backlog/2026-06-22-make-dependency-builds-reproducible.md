...
- Validation: Run `npm run build` from `frontend/` after lockfile changes.
- Validation: Run `python -m pytest backend/tests` from the repo root with backend dependencies installed after backend constraint changes.
